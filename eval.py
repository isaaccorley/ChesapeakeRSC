import argparse
import os
from src.datasets import ChesapeakeSpatialReasoning
...
def main(args):
    ...
    ds = ChesapeakeSpatialReasoning("data/ChesapeakeSpatialReasoning/", split=args.eval_set, differentiate_tree_canopy_over_roads=True, transforms=preprocess)
